...
public class Blockchain {
    ...
    public static HashMap<String,TransactionOutput> TOs = new HashMap<String,TransactionOutput>();
    ...
    public static void main(String[] args) {
        ...
        TOs.put(genesisTransaction.outputs.get(0).id, genesisTransaction.outputs.get(0)); //its important to store our first transaction in the UTXOs list.
    ...
    public static Boolean isChainValid() {
        ...
        for (int i = 1; i < blockchain.size(); i++) {
            ...
            if (!currentBlock.hash.substring(0, difficulty).equals(hashTarget)) {
                System.out.println("#This block hasn't been mined " + currentBlock.transactions.get(0).value);
                return false;
            }
            ...
            for (int t = 0; t < currentBlock.transactions.size(); t++) {
                ...
                for (TransactionInput input : currentTransaction.inputs) {
                    ...
                    if (input.TO.value != tempOutput.value) {
